...
from datapusher import semantics

# check whether semantics have been imported properly
assert(semantics.push_to_fuseki)
...
def push_to_datastore(task_id, input, dry_run=False):
    ...
    tmp_file_fuseki.write(get_data_response(url).text)
